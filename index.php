...
<main id="main" class="container mx-auto py-10">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php
        foreach ($contenus as $contenu) {
            echo 
            '<div class="bg-white p-4 rounded-lg shadow-lg mb-4 flex flex-col h-200"> <!-- h-96 fixe la hauteur -->
                <h2 class="text-lg font-medium mb-2"><a href="user_ac.php?pseudo='.$contenu['pseudo'].'" class="text-indigo-600 hover:underline">'.$contenu['pseudo'].'</a></h2>
                <a href="content.php?contenu='.$contenu["id"].'"><img src="' . 'images/' . $contenu['chemin_image'] . '" class="meme w-full object-cover rounded h-80" /></a>
                ...
                <p class="mt-2 flex-1 overflow-hidden text-ellipsis">' . $contenu['description'] . '</p>
                <div class="carrecommentaire mt-2 bg-gray-100 rounded p-2 overflow-y-auto" style="max-height:120px;">' . $contenu['messages'] . '</div>';
